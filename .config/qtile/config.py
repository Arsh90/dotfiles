...
dmenu_conf = "-i -l 10 -nb '#2C2439' -sb '#3D3250' -sf '#C4C7C5' -fn 'Source Code Pro Medium'"
...
keys = [
    ...
    Key([mod], "d",
        lazy.spawn(f"dmenu_run -p 'Run Command:'"),
        desc="Launches dmenu"
    ),
    Key([mod], "n",
        lazy.spawn(f"networkmanager_dmenu"),
    ...
    Key([mod], "o", lazy.spawn("bash ~/script/schoolscrape/classes")),
